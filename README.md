...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xdem-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12888&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xdem-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xdem` can be installed with:

```
conda install xdem
```

It is possible to list all of the versions of `xdem` available on your platform with:
